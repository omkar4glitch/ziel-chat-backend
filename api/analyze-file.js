...
1. **Financial Validation**
   - Totals and balances have already been calculated by the system.
     DO NOT recompute, re-verify, or cross-check totals.
     Only COMMENT on whether the provided totals indicate a mismatch.
...
1. **Income Statement Analysis**
   ...
   - Gross Profit
   - Net Profit/Loss
   - Comment on margins and ratios ONLY if explicitly provided in summary.
  ...
  // Create a clean, readable JSON representation for the AI
    const dataForAI = {
      ...
      sheets: structuredData.sheets.map(sheet => ({
        ...
        dataSample: sheet.data.slice(0, 20),
        note: "All totals are pre-calculated by backend. Do NOT recompute."
      }))
    };
