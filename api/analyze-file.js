...
NO cost structure analysis (dont give cost struture analysis) give only key observations)
...
(6-7 specific bullet observations with exact figures for the specified ${unitWord}(s).)
