...
/**
 * PRE-PROCESS GL DATA (no stray try/catch here)
 */
...
3. ALL accounts from the uploaded GL file are already summarized in the data
...
3. Use the account summary table(s) already provided in the input
4. Add observations:
